...
|---|---|---|---|---:|---|
| `dev-azure` | 2026-07-17 00:28Z | `d70b7e6` | ✅ passed | 100% (1) | 1209h |
...
| `code-quality` | 2026-09-05 08:12Z | ❌ failed | failed_jobs=1, skipped_jobs=0 |
...
|---|---|---|
| `pipeline-daily` | 2026-09-05 09:53Z | ✅ passed |
| `monitor-actions` | 2026-09-05 09:17Z | ✅ passed |
