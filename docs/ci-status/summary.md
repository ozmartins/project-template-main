...
|---|---|---|---|---:|---|
| `dev-azure` | 2026-07-17 00:28Z | `d70b7e6` | ✅ passed | 100% (1) | 949h |
...
| `code-quality` | 2026-08-25 04:43Z | ❌ failed | failed_jobs=1, skipped_jobs=0 |
...
|---|---|---|
| `pipeline-daily` | 2026-08-25 06:38Z | ✅ passed |
| `monitor-actions` | 2026-08-25 13:12Z | ✅ passed |
