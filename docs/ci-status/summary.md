...
|---|---|---|---|---:|---|
| `dev-azure` | 2026-07-17 00:28Z | `d70b7e6` | ✅ passed | 100% (1) | 35h |
...
|---|---|---|---:|
| `architecture-audit` | 2026-07-18 07:47Z | ✅ passed | 0 |
| `audit-cis-kubernetes` | 2026-07-18 08:19Z | 🟠 error | 0 |
| `audit-azure-security` | 2026-07-18 09:08Z | 🟠 error | 0 |

## Ops workflows

| Workflow | Last run | Outcome |
|---|---|---|
| `pipeline-daily` | 2026-07-18 07:42Z | ✅ passed |
| `monitor-actions` | 2026-07-18 11:08Z | ✅ passed |
