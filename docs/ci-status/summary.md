...
|---|---|---|---|---:|---|
| `dev-azure` | 2026-07-17 00:28Z | `d70b7e6` | ✅ passed | 100% (1) | 82h |
...
| `code-quality` | 2026-07-20 06:51Z | ❌ failed | failed_jobs=1, skipped_jobs=0 |
...
| `monitor-actions` | 2026-07-20 10:31Z | ✅ passed |
