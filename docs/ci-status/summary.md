...
|---|---|---|---|---:|---|
| `dev-azure` | 2026-07-17 00:28Z | `d70b7e6` | ✅ passed | 100% (1) | 210h |
...
| `code-quality` | 2026-07-25 06:22Z | ❌ failed | failed_jobs=1, skipped_jobs=0 |

## Security & audits

| Workflow | Last run | Outcome | Finding count |
|---|---|---|---:|
| `architecture-audit` | 2026-07-25 08:04Z | ✅ passed | 0 |
| `audit-cis-kubernetes` | 2026-07-25 08:21Z | 🟠 error | 0 |
| `audit-azure-security` | 2026-07-25 09:10Z | 🟠 error | 0 |

## Ops workflows

| Workflow | Last run | Outcome |
|---|---|---|
| `pipeline-daily` | 2026-07-25 08:01Z | ✅ passed |
| `monitor-actions` | 2026-07-25 17:35Z | ✅ passed |
