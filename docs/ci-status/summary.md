...
|---|---|---|---|---:|---|
| `dev-azure` | 2026-07-17 00:28Z | `d70b7e6` | ✅ passed | 100% (1) | 286h |
...
| `code-quality` | 2026-07-28 06:30Z | ❌ failed | failed_jobs=1, skipped_jobs=0 |
...
| `audit-cis-kubernetes` | 2026-07-28 08:22Z | 🟠 error | 0 |
...
|---|---|---|
| `pipeline-daily` | 2026-07-28 08:27Z | ✅ passed |
| `monitor-actions` | 2026-07-28 21:41Z | ✅ passed |
