...
|---|---|---|---|---:|---|
| `dev-azure` | 2026-07-17 00:28Z | `d70b7e6` | ✅ passed | 100% (1) | 324h |
...
| `code-quality` | 2026-07-30 06:32Z | ❌ failed | failed_jobs=1, skipped_jobs=0 |
...
| `audit-cis-kubernetes` | 2026-07-30 08:23Z | 🟠 error | 0 |
...
|---|---|---|
| `pipeline-daily` | 2026-07-30 08:18Z | ✅ passed |
| `monitor-actions` | 2026-07-30 12:00Z | ✅ passed |
