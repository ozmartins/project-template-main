...
|---|---|---|---|---:|---|
| `dev-azure` | 2026-07-17 00:28Z | `d70b7e6` | ✅ passed | 100% (1) | 1564h |
...
| `code-quality` | 2026-09-19 08:41Z | ❌ failed | failed_jobs=1, skipped_jobs=0 |

## Security & audits

| Workflow | Last run | Outcome | Finding count |
|---|---|---|---:|
| `architecture-audit` | 2026-09-19 10:20Z | ✅ passed | 0 |
| `audit-cis-kubernetes` | 2026-09-19 15:02Z | 🟠 error | 0 |
| `audit-azure-security` | 2026-09-19 16:37Z | 🟠 error | 0 |

## Ops workflows

| Workflow | Last run | Outcome |
|---|---|---|
| `pipeline-daily` | 2026-09-19 10:13Z | ✅ passed |
| `monitor-actions` | 2026-09-20 04:45Z | ✅ passed |
