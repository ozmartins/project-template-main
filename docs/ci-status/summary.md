...
|---|---|---|---|---:|---|
| `dev-azure` | 2026-07-17 00:28Z | `d70b7e6` | ✅ passed | 100% (1) | 427h |
...
|---|---|---|---:|
| `architecture-audit` | 2026-08-03 09:41Z | ✅ passed | 0 |
| `audit-cis-kubernetes` | 2026-08-03 08:24Z | 🟠 error | 0 |
| `audit-azure-security` | 2026-08-03 09:16Z | 🟠 error | 0 |

## Ops workflows

| Workflow | Last run | Outcome |
|---|---|---|
| `pipeline-daily` | 2026-08-03 09:35Z | ✅ passed |
| `monitor-actions` | 2026-08-03 18:28Z | ✅ passed |
