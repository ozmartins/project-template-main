...
|---|---|---|---|---:|---|
| `dev-azure` | 2026-07-17 00:28Z | `d70b7e6` | ✅ passed | 100% (1) | 1090h |
...
| `code-quality` | 2026-08-31 10:42Z | ❌ failed | failed_jobs=1, skipped_jobs=0 |

## Security & audits

| Workflow | Last run | Outcome | Finding count |
|---|---|---|---:|
| `architecture-audit` | 2026-08-30 11:17Z | ✅ passed | 0 |
| `audit-cis-kubernetes` | 2026-08-30 14:55Z | 🟠 error | 0 |
| `audit-azure-security` | 2026-08-30 16:29Z | 🟠 error | 0 |

## Ops workflows

| Workflow | Last run | Outcome |
|---|---|---|
| `pipeline-daily` | 2026-08-30 11:08Z | ✅ passed |
| `monitor-actions` | 2026-08-31 07:27Z | ✅ passed |
