...
|---|---|---|---|---:|---|
| `dev-azure` | 2026-07-17 00:28Z | `d70b7e6` | ✅ passed | 100% (1) | 1158h |
...
| `code-quality` | 2026-09-02 08:36Z | ❌ failed | failed_jobs=1, skipped_jobs=0 |
...
|---|---|---|
| `pipeline-daily` | 2026-09-02 10:30Z | ✅ passed |
