...
|---|---|---|---|---:|---|
| `dev-azure` | 2026-07-17 00:28Z | `d70b7e6` | ✅ passed | 100% (1) | 1541h |
...
| `code-quality` | 2026-09-18 08:55Z | ❌ failed | failed_jobs=1, skipped_jobs=0 |

## Security & audits

| Workflow | Last run | Outcome | Finding count |
|---|---|---|---:|
| `architecture-audit` | 2026-09-18 10:36Z | ✅ passed | 0 |
...
|---|---|---|
| `pipeline-daily` | 2026-09-18 10:28Z | ✅ passed |
| `monitor-actions` | 2026-09-19 01:04Z | ✅ passed |
