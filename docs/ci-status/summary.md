...
|---|---|---|---|---:|---|
| `dev-azure` | 2026-07-17 00:28Z | `d70b7e6` | ✅ passed | 100% (1) | 1631h |
...
| `code-quality` | 2026-09-22 09:11Z | ❌ failed | failed_jobs=1, skipped_jobs=0 |
...
|---|---|---|
| `pipeline-daily` | 2026-09-22 10:52Z | ✅ passed |
| `monitor-actions` | 2026-09-22 23:13Z | ✅ passed |
