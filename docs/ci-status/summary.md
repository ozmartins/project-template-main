...
|---|---|---|---|---:|---|
| `dev-azure` | 2026-07-17 00:28Z | `d70b7e6` | ✅ passed | 100% (1) | 255h |
...
| `code-quality` | 2026-07-27 07:37Z | ❌ failed | failed_jobs=1, skipped_jobs=0 |

## Security & audits

| Workflow | Last run | Outcome | Finding count |
|---|---|---|---:|
| `architecture-audit` | 2026-07-27 09:49Z | ✅ passed | 0 |
| `audit-cis-kubernetes` | 2026-07-27 08:22Z | 🟠 error | 0 |
| `audit-azure-security` | 2026-07-27 09:11Z | 🟠 error | 0 |

## Ops workflows

| Workflow | Last run | Outcome |
|---|---|---|
| `pipeline-daily` | 2026-07-27 09:42Z | ✅ passed |
| `monitor-actions` | 2026-07-27 15:31Z | ✅ passed |
