...
|---|---|---|---|---:|---|
| `dev-azure` | 2026-07-17 00:28Z | `d70b7e6` | ✅ passed | 100% (1) | 544h |
...
| `code-quality` | 2026-08-08 05:01Z | ❌ failed | failed_jobs=1, skipped_jobs=0 |

## Security & audits

| Workflow | Last run | Outcome | Finding count |
|---|---|---|---:|
| `architecture-audit` | 2026-08-08 06:50Z | ✅ passed | 0 |
| `audit-cis-kubernetes` | 2026-08-08 08:26Z | 🟠 error | 0 |
...
|---|---|---|
| `pipeline-daily` | 2026-08-08 06:44Z | ✅ passed |
| `monitor-actions` | 2026-08-08 16:39Z | ✅ passed |
