...
|---|---|---|---|---:|---|
| `dev-azure` | 2026-07-17 00:28Z | `d70b7e6` | ✅ passed | 100% (1) | 894h |
...
| `code-quality` | 2026-08-23 04:41Z | ❌ failed | failed_jobs=1, skipped_jobs=0 |

## Security & audits

| Workflow | Last run | Outcome | Finding count |
|---|---|---|---:|
| `architecture-audit` | 2026-08-23 06:37Z | ✅ passed | 0 |
...
|---|---|---|
| `pipeline-daily` | 2026-08-23 06:33Z | ✅ passed |
| `monitor-actions` | 2026-08-23 06:03Z | ✅ passed |
