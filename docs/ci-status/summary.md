...
|---|---|---|---|---:|---|
| `dev-azure` | 2026-07-17 00:28Z | `d70b7e6` | ✅ passed | 100% (1) | 1713h |
...
| `code-quality` | 2026-09-26 09:15Z | ❌ failed | failed_jobs=1, skipped_jobs=0 |
...
| `monitor-actions` | 2026-09-26 05:02Z | ✅ passed |
