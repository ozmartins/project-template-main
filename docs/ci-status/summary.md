...
|---|---|---|---|---:|---|
| `dev-azure` | 2026-07-17 00:28Z | `d70b7e6` | ✅ passed | 100% (1) | 1704h |
...
| `code-quality` | 2026-09-25 09:30Z | ❌ failed | failed_jobs=1, skipped_jobs=0 |

## Security & audits

| Workflow | Last run | Outcome | Finding count |
|---|---|---|---:|
| `architecture-audit` | 2026-09-25 11:11Z | ✅ passed | 0 |
| `audit-cis-kubernetes` | 2026-09-25 15:04Z | 🟠 error | 0 |
| `audit-azure-security` | 2026-09-25 16:39Z | 🟠 error | 0 |

## Ops workflows

| Workflow | Last run | Outcome |
|---|---|---|
| `pipeline-daily` | 2026-09-25 11:01Z | ✅ passed |
| `monitor-actions` | 2026-09-26 00:04Z | ✅ passed |
