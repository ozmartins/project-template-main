...
|---|---|---|---|---:|---|
| `dev-azure` | 2026-07-17 00:28Z | `d70b7e6` | ✅ passed | 100% (1) | 1403h |
...
| `code-quality` | 2026-09-13 09:22Z | ❌ failed | failed_jobs=1, skipped_jobs=0 |

## Security & audits

| Workflow | Last run | Outcome | Finding count |
|---|---|---|---:|
| `architecture-audit` | 2026-09-13 11:06Z | ✅ passed | 0 |
...
|---|---|---|
| `pipeline-daily` | 2026-09-13 11:00Z | ✅ passed |
| `monitor-actions` | 2026-09-13 05:50Z | ✅ passed |
