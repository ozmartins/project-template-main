...
|---|---|---|---|---:|---|
| `dev-azure` | 2026-06-24 20:23Z | `f36d6a4` | ✅ passed | 100% (1) | 252h |
...
| `code-quality` | 2026-07-05 07:31Z | ❌ failed | failed_jobs=1, skipped_jobs=0 |
...
| `monitor-actions` | 2026-07-05 05:42Z | ✅ passed |
