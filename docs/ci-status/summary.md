...
|---|---|---|---|---:|---|
| `dev-azure` | 2026-07-17 00:28Z | `d70b7e6` | ✅ passed | 100% (1) | 126h |
...
|---|---|---|---:|
| `architecture-audit` | 2026-07-21 08:25Z | ✅ passed | 0 |
| `audit-cis-kubernetes` | 2026-07-21 08:20Z | 🟠 error | 0 |
| `audit-azure-security` | 2026-07-21 09:09Z | 🟠 error | 0 |

## Ops workflows

| Workflow | Last run | Outcome |
|---|---|---|
| `pipeline-daily` | 2026-07-21 08:21Z | ✅ passed |
| `monitor-actions` | 2026-07-22 04:35Z | ✅ passed |
