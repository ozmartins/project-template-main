...
|---|---|---|---|---:|---|
| `dev-azure` | 2026-07-17 00:28Z | `d70b7e6` | ✅ passed | 100% (1) | 24h |
...
| `code-quality` | 2026-07-17 06:21Z | ❌ failed | failed_jobs=1, skipped_jobs=0 |
...
| `monitor-actions` | 2026-07-18 00:11Z | ✅ passed |
