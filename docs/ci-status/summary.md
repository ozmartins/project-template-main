...
|---|---|---|---|---:|---|
| `dev-azure` | 2026-07-17 00:28Z | `d70b7e6` | ✅ passed | 100% (1) | 1438h |
...
| `audit-cis-kubernetes` | 2026-09-14 15:00Z | 🟠 error | 0 |
| `audit-azure-security` | 2026-09-14 16:35Z | 🟠 error | 0 |
...
| `monitor-actions` | 2026-09-14 22:07Z | ✅ passed |
