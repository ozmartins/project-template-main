...
|---|---|---|---|---:|---|
| `dev-azure` | 2026-07-17 00:28Z | `d70b7e6` | ✅ passed | 100% (1) | 1329h |
...
|---|---|---|---:|
| `architecture-audit` | 2026-09-09 10:46Z | ✅ passed | 0 |
| `audit-cis-kubernetes` | 2026-09-09 14:59Z | 🟠 error | 0 |
| `audit-azure-security` | 2026-09-09 16:32Z | 🟠 error | 0 |

## Ops workflows

| Workflow | Last run | Outcome |
|---|---|---|
| `pipeline-daily` | 2026-09-09 10:41Z | ✅ passed |
| `monitor-actions` | 2026-09-10 09:05Z | ✅ passed |
