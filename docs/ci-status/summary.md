...
|---|---|---|---|---:|---|
| `dev-azure` | 2026-07-17 00:28Z | `d70b7e6` | ✅ passed | 100% (1) | 515h |
...
| `code-quality` | 2026-08-07 05:44Z | ❌ failed | failed_jobs=1, skipped_jobs=0 |

## Security & audits

| Workflow | Last run | Outcome | Finding count |
|---|---|---|---:|
| `architecture-audit` | 2026-08-07 07:12Z | ✅ passed | 0 |
| `audit-cis-kubernetes` | 2026-08-07 08:26Z | 🟠 error | 0 |
| `audit-azure-security` | 2026-08-07 09:18Z | 🟠 error | 0 |

## Ops workflows

| Workflow | Last run | Outcome |
|---|---|---|
| `pipeline-daily` | 2026-08-07 07:08Z | ✅ passed |
| `monitor-actions` | 2026-08-07 11:33Z | ✅ passed |
