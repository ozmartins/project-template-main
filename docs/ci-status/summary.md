...
|---|---|---|---|---:|---|
| `dev-azure` | 2026-07-17 00:28Z | `d70b7e6` | ✅ passed | 100% (1) | 1550h |
...
| `audit-cis-kubernetes` | 2026-09-18 15:01Z | 🟠 error | 0 |
| `audit-azure-security` | 2026-09-18 16:36Z | 🟠 error | 0 |
...
| `monitor-actions` | 2026-09-19 14:15Z | ✅ passed |
