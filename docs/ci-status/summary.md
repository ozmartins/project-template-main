...
|---|---|---|---|---:|---|
| `dev-azure` | 2026-07-17 00:28Z | `d70b7e6` | ✅ passed | 100% (1) | 1429h |
...
| `code-quality` | 2026-09-14 09:42Z | ❌ failed | failed_jobs=1, skipped_jobs=0 |

## Security & audits

| Workflow | Last run | Outcome | Finding count |
|---|---|---|---:|
| `architecture-audit` | 2026-09-14 11:50Z | ✅ passed | 0 |
| `audit-cis-kubernetes` | 2026-09-13 15:00Z | 🟠 error | 0 |
| `audit-azure-security` | 2026-09-13 16:34Z | 🟠 error | 0 |

## Ops workflows

| Workflow | Last run | Outcome |
|---|---|---|
| `pipeline-daily` | 2026-09-14 11:37Z | ✅ passed |
| `monitor-actions` | 2026-09-14 13:14Z | ✅ passed |
