...
|---|---|---|---|---:|---|
| `dev-azure` | 2026-07-17 00:28Z | `d70b7e6` | ✅ passed | 100% (1) | 1127h |
...
|---|---|---|---:|
| `architecture-audit` | 2026-09-01 11:07Z | ✅ passed | 0 |
| `audit-cis-kubernetes` | 2026-09-01 14:56Z | 🟠 error | 0 |
| `audit-azure-security` | 2026-09-01 16:29Z | 🟠 error | 0 |

## Ops workflows

| Workflow | Last run | Outcome |
|---|---|---|
| `pipeline-daily` | 2026-09-01 11:00Z | ✅ passed |
| `monitor-actions` | 2026-09-01 23:29Z | ✅ passed |
