...
|---|---|---|---|---:|---|
| `dev-azure` | 2026-07-17 00:28Z | `d70b7e6` | ✅ passed | 100% (1) | 443h |
...
|---|---|---|---:|
| `architecture-audit` | 2026-08-04 08:33Z | ✅ passed | 0 |
| `audit-cis-kubernetes` | 2026-08-04 08:25Z | 🟠 error | 0 |
| `audit-azure-security` | 2026-08-04 09:18Z | 🟠 error | 0 |

## Ops workflows

| Workflow | Last run | Outcome |
|---|---|---|
| `pipeline-daily` | 2026-08-04 08:30Z | ✅ passed |
| `monitor-actions` | 2026-08-04 11:34Z | ✅ passed |
