...
|---|---|---|---|---:|---|
| `dev-azure` | 2026-06-24 20:23Z | `f36d6a4` | ✅ passed | 100% (1) | 371h |
...
| `audit-cis-kubernetes` | 2026-07-09 08:16Z | 🟠 error | 0 |
| `audit-azure-security` | 2026-07-09 09:06Z | 🟠 error | 0 |
...
| `monitor-actions` | 2026-07-10 05:41Z | ✅ passed |
