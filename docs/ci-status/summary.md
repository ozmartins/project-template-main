...
|---|---|---|---|---:|---|
| `dev-azure` | 2026-07-17 00:28Z | `d70b7e6` | ✅ passed | 100% (1) | 1668h |
...
| `audit-cis-kubernetes` | 2026-09-23 15:03Z | 🟠 error | 0 |
| `audit-azure-security` | 2026-09-23 16:38Z | 🟠 error | 0 |
...
| `monitor-actions` | 2026-09-24 12:18Z | ✅ passed |
