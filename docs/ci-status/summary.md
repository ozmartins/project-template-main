...
|---|---|---|---|---:|---|
| `dev-azure` | 2026-07-17 00:28Z | `d70b7e6` | ✅ passed | 100% (1) | 610h |
...
| `code-quality` | 2026-08-11 05:13Z | ❌ failed | failed_jobs=1, skipped_jobs=0 |

## Security & audits

| Workflow | Last run | Outcome | Finding count |
|---|---|---|---:|
| `architecture-audit` | 2026-08-11 07:04Z | ✅ passed | 0 |
| `audit-cis-kubernetes` | 2026-08-11 08:27Z | 🟠 error | 0 |
| `audit-azure-security` | 2026-08-11 09:20Z | 🟠 error | 0 |

## Ops workflows

| Workflow | Last run | Outcome |
|---|---|---|
| `pipeline-daily` | 2026-08-11 06:59Z | ✅ passed |
| `monitor-actions` | 2026-08-11 10:12Z | ✅ passed |
