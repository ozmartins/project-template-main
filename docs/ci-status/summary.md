...
|---|---|---|---|---:|---|
| `dev-azure` | 2026-07-17 00:28Z | `d70b7e6` | ✅ passed | 100% (1) | 925h |
...
| `code-quality` | 2026-08-24 04:50Z | ❌ failed | failed_jobs=1, skipped_jobs=0 |

## Security & audits

| Workflow | Last run | Outcome | Finding count |
|---|---|---|---:|
| `architecture-audit` | 2026-08-24 06:54Z | ✅ passed | 0 |
| `audit-cis-kubernetes` | 2026-08-24 08:32Z | 🟠 error | 0 |
| `audit-azure-security` | 2026-08-24 09:24Z | 🟠 error | 0 |

## Ops workflows

| Workflow | Last run | Outcome |
|---|---|---|
| `pipeline-daily` | 2026-08-24 06:48Z | ✅ passed |
| `monitor-actions` | 2026-08-24 13:14Z | ✅ passed |
