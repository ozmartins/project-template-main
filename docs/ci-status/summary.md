...
|---|---|---|---|---:|---|
| `dev-azure` | 2026-07-17 00:28Z | `d70b7e6` | ✅ passed | 100% (1) | 752h |
...
| `code-quality` | 2026-08-17 04:47Z | ❌ failed | failed_jobs=1, skipped_jobs=0 |

## Security & audits

| Workflow | Last run | Outcome | Finding count |
|---|---|---|---:|
| `architecture-audit` | 2026-08-17 06:51Z | ✅ passed | 0 |
| `audit-cis-kubernetes` | 2026-08-17 08:29Z | 🟠 error | 0 |
...
|---|---|---|
| `pipeline-daily` | 2026-08-17 06:44Z | ✅ passed |
| `monitor-actions` | 2026-08-17 08:25Z | ✅ passed |
