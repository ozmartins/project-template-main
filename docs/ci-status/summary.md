...
|---|---|---|---|---:|---|
| `dev-azure` | 2026-07-17 00:28Z | `d70b7e6` | ✅ passed | 100% (1) | 510h |
...
|---|---|---|---:|
| `architecture-audit` | 2026-08-06 08:33Z | ✅ passed | 0 |
| `audit-cis-kubernetes` | 2026-08-06 08:26Z | 🟠 error | 0 |
| `audit-azure-security` | 2026-08-06 09:18Z | 🟠 error | 0 |

## Ops workflows

| Workflow | Last run | Outcome |
|---|---|---|
| `pipeline-daily` | 2026-08-06 08:28Z | ✅ passed |
| `monitor-actions` | 2026-08-07 06:49Z | ✅ passed |
