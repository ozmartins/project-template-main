...
|---|---|---|---|---:|---|
| `dev-azure` | 2026-07-17 00:28Z | `d70b7e6` | ✅ passed | 100% (1) | 970h |
...
| `audit-cis-kubernetes` | 2026-08-26 08:32Z | 🟠 error | 0 |
| `audit-azure-security` | 2026-08-26 09:24Z | 🟠 error | 0 |
...
| `monitor-actions` | 2026-08-26 10:45Z | ✅ passed |
