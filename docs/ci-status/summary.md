...
|---|---|---|---|---:|---|
| `dev-azure` | 2026-07-17 00:28Z | `d70b7e6` | ✅ passed | 100% (1) | 800h |
...
| `code-quality` | 2026-08-19 04:41Z | ❌ failed | failed_jobs=1, skipped_jobs=0 |

## Security & audits

| Workflow | Last run | Outcome | Finding count |
|---|---|---|---:|
| `architecture-audit` | 2026-08-19 06:40Z | ✅ passed | 0 |
| `audit-cis-kubernetes` | 2026-08-19 08:30Z | 🟠 error | 0 |
| `audit-azure-security` | 2026-08-18 09:22Z | 🟠 error | 0 |

## Ops workflows

| Workflow | Last run | Outcome |
|---|---|---|
| `pipeline-daily` | 2026-08-19 06:36Z | ✅ passed |
| `monitor-actions` | 2026-08-19 08:43Z | ✅ passed |
