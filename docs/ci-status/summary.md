...
|---|---|---|---|---:|---|
| `dev-azure` | 2026-07-17 00:28Z | `d70b7e6` | ✅ passed | 100% (1) | 664h |
...
|---|---|---|---:|
| `architecture-audit` | 2026-08-13 07:24Z | ✅ passed | 0 |
| `audit-cis-kubernetes` | 2026-08-13 08:28Z | 🟠 error | 0 |
| `audit-azure-security` | 2026-08-13 09:20Z | 🟠 error | 0 |

## Ops workflows

| Workflow | Last run | Outcome |
|---|---|---|
| `pipeline-daily` | 2026-08-13 07:20Z | ✅ passed |
| `monitor-actions` | 2026-08-13 15:16Z | ✅ passed |
