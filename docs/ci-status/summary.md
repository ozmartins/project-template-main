...
|---|---|---|---|---:|---|
| `dev-azure` | 2026-07-17 00:28Z | `d70b7e6` | ✅ passed | 100% (1) | 777h |
...
| `code-quality` | 2026-08-18 04:39Z | ❌ failed | failed_jobs=1, skipped_jobs=0 |

## Security & audits

| Workflow | Last run | Outcome | Finding count |
|---|---|---|---:|
| `architecture-audit` | 2026-08-18 06:39Z | ✅ passed | 0 |
| `audit-cis-kubernetes` | 2026-08-18 08:29Z | 🟠 error | 0 |
...
|---|---|---|
| `pipeline-daily` | 2026-08-18 06:35Z | ✅ passed |
| `monitor-actions` | 2026-08-18 09:49Z | ✅ passed |
