...
|---|---|---|---|---:|---|
| `dev-azure` | 2026-07-17 00:28Z | `d70b7e6` | ✅ passed | 100% (1) | 1035h |
...
| `code-quality` | 2026-08-28 16:27Z | ❌ failed | failed_jobs=1, skipped_jobs=0 |

## Security & audits

| Workflow | Last run | Outcome | Finding count |
|---|---|---|---:|
| `architecture-audit` | 2026-08-28 18:12Z | ✅ passed | 0 |
| `audit-cis-kubernetes` | 2026-08-28 13:49Z | 🟠 error | 0 |
...
|---|---|---|
| `pipeline-daily` | 2026-08-28 18:08Z | ✅ passed |
| `monitor-actions` | 2026-08-29 03:20Z | ✅ passed |
