...
|---|---|---|---|---:|---|
| `dev-azure` | 2026-07-17 00:28Z | `d70b7e6` | ✅ passed | 100% (1) | 1282h |
...
|---|---|---|---:|
| `architecture-audit` | 2026-09-07 11:37Z | ✅ passed | 0 |
| `audit-cis-kubernetes` | 2026-09-07 14:58Z | 🟠 error | 0 |
| `audit-azure-security` | 2026-09-07 16:31Z | 🟠 error | 0 |

## Ops workflows

| Workflow | Last run | Outcome |
|---|---|---|
| `pipeline-daily` | 2026-09-07 11:26Z | ✅ passed |
| `monitor-actions` | 2026-09-08 09:59Z | ✅ passed |
